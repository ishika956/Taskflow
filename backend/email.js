...
console.log(
  "BREVO_SMTP_USER:",
  process.env.BREVO_SMTP_USER ? "FOUND" : "MISSING"
);

console.log(
  "BREVO_SMTP_PASS:",
  process.env.BREVO_SMTP_PASS ? "FOUND" : "MISSING"
);
      ...
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:auto;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden">
          ...
          <div style="padding:24px">
            ...
            <p>
              <strong>${assignedBy}</strong> assigned you a new task:
            </p>
...
const sendInvitationEmail = async ({
  ...
  try {
    ...
    const declineUrl =
      `${baseUrl}/invite/decline?token=${token}`;

    const roleDescriptions = {
      Admin:
        'manage projects, tasks, and invite members',

      Manager:
        'manage projects and tasks, approve member requests',

      Member:
        'view the board, request tasks, and mark tasks as done',
    };
